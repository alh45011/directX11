...
void Camera::UpdateViewMatrix() //Updates view matrix and also updates the movement vectors
{
	...
	XMMATRIX vecRotationMatrix2 = XMMatrixRotationRollPitchYaw(this->rot.x, this->rot.y, 0.0f);
	this->camTarget = this->vec_forward = XMVector3TransformCoord(this->DEFAULT_FORWARD_VECTOR, vecRotationMatrix2);
...
const XMVECTOR& Camera::GetCamTargetVector()
{
